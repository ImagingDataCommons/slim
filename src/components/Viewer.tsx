...
class Viewer extends React.Component<ViewerProps, ViewerState> {
  ...
  handleSeriesSelection (
    ...
    this.props.client.retrieveSeriesMetadata({
      ...
      const volumeMetadata = retrievedMetadata.filter(item => {
        const metadata = dmv.metadata.formatMetadata(item) as dmv.metadata.VLWholeSlideMicroscopyImage
        ...
        matchedInstances.forEach(i => {
          ...
          this.props.client.retrieveInstance({
            ...
            content.ROIs.forEach(roi => {
              ...
              const image = (
                this.state.selectedSeriesMetadata[0] as
