...
> {
  ...
  handleColorRChange(value: number | number[]): void {
    const identifier = this.props.opticalPath.identifier;
  ...
  handleColorGChange(value: number | number[]): void {
    const identifier = this.props.opticalPath.identifier;
    if (this.state.currentStyle.color !== undefined) {
      const color = [
  ...
  handleColorBChange(value: number | number[]): void {
    const identifier = this.props.opticalPath.identifier;
    if (this.state.currentStyle.color !== undefined) {
      const color = [
        this.state.currentStyle.color[0],
  ...
  handleLowerLimitChange(value: number): void {
    const identifier = this.props.opticalPath.identifier;
  ...
  handleUpperLimitChange(value: number): void {
    const identifier = this.props.opticalPath.identifier;
    if (this.state.currentStyle.limitValues !== undefined) {
      this.setState((state) => {
        if (state.currentStyle.limitValues !== undefined) {
  ...
  render(): React.ReactNode {
    ...
    try {
      ...
      ErrorMiddleware.onError("dcmjs", error);
    }
